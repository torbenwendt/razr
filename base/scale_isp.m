function pos = scale_isp(isd, room, obj)
...
%
% Output:
%   pos     5-column matrix with [x, y, z, azim, elev] per image object
%
...
for n = 1:numSrc
    ...
    % azimuth:
    pos(n, 4) = (dirctn(1) - ...
        isd.invert_pos(n, 1)*180)*(1 - 2*isd.invert_pos(n, 1))*(1 - 2*isd.invert_pos(n, 2));
    % elevation:
    pos(n, 5) = room.srcdir(2)*(1 - 2*isd.invert_pos(n, 3));
end
